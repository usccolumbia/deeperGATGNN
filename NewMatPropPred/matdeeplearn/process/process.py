...
def process_data(data_path, processed_path, processing_args):
    ...
    for index in range(0, 1):
        ...
        #structure_id = 'test'
        fileName =  processing_args["file_name"].split(".")
        structure_id = fileName[0]
        data = Data()
        ...
        if processing_args["verbose"] == "True" and (
            (index + 1) % 500 == 0 or (index + 1) == 1
        ):
            print("Data processed: ", index + 1, "out of", 1)
            # if index == 0:
            # print(data)
    ...
    if processing_args["edge_features"] == "True":
        ...
        for index in range(0, len(data_list)):
            ...
            if processing_args["verbose"] == "True" and (
                ...
                print("Edge processed: ", index + 1, "out of", 1)
